...
INSERT INTO app_order (customer_id, order_date, status, total_price, payment_method, is_paid, shipped_at, tracking_code, shipping_address_id, billing_address_id, shipping_fee) VALUES
(3, DATEADD(DAY,-30,GETDATE()), N'COMPLETED', 747000, N'COD',   1, NULL,                          NULL,            1, 1, 20000),
(3, DATEADD(DAY,-15,GETDATE()), N'COMPLETED', 549000, N'VNPAY', 1, NULL,                          NULL,            1, 1, 20000),
(3, DATEADD(DAY, -5,GETDATE()), N'SHIPPING',  398000, N'COD',   0, DATEADD(DAY,-4,GETDATE()),     N'GHN-20250001', 2, 2, 20000),
(3, DATEADD(DAY, -1,GETDATE()), N'PENDING',   199000, N'COD',   0, NULL,                          NULL,            1, 1, 20000);

-- tranthib (user 4) – 3 đơn: id 5-7 (giao TP.HCM)
INSERT INTO app_order (customer_id, order_date, status, total_price, payment_method, is_paid, shipped_at, tracking_code, shipping_address_id, billing_address_id, shipping_fee) VALUES
(4, DATEADD(DAY,-20,GETDATE()), N'COMPLETED', 799000, N'VNPAY', 1, NULL, NULL, 3, 3, 38000),
(4, DATEADD(DAY, -8,GETDATE()), N'CONFIRMED', 598000, N'COD',   0, NULL, NULL, 3, 3, 38000),
(4, DATEADD(DAY, -2,GETDATE()), N'PENDING',   249000, N'VNPAY', 0, NULL, NULL, 3, 3, 38000);

-- levanc (user 5) – 3 đơn: id 8-10 (giao Đà Nẵng)
INSERT INTO app_order (customer_id, order_date, status, total_price, payment_method, is_paid, shipped_at, tracking_code, shipping_address_id, billing_address_id, shipping_fee) VALUES
(5, DATEADD(DAY,-25,GETDATE()), N'COMPLETED', 599000, N'COD',   1, NULL,                      NULL,            4, 4, 32000),
(5, DATEADD(DAY, -7,GETDATE()), N'COMPLETED', 599000, N'COD',   1, DATEADD(DAY,-6,GETDATE()), N'GHN-20250002', 4, 4, 32000),
(5, DATEADD(DAY, -3,GETDATE()), N'CONFIRMED', 349000, N'VNPAY', 1, NULL,                      NULL,            4, 4, 32000);

-- phamthid (user 6) – 2 đơn: id 11-12 (giao TP.HCM)
INSERT INTO app_order (customer_id, order_date, status, total_price, payment_method, is_paid, shipped_at, tracking_code, shipping_address_id, billing_address_id, shipping_fee) VALUES
(6, DATEADD(DAY,-10,GETDATE()), N'COMPLETED',  448000, N'COD',   0, DATEADD(DAY,-9,GETDATE()), N'GHN-20250003', 5, 5, 38000),
(6, DATEADD(DAY, -1,GETDATE()), N'PENDING',   498000, N'COD',   0, NULL,                      NULL,            5, 5, 38000);

-- hoangvane (user 7) – 2 đơn: id 13-14 (giao Hà Nội)
INSERT INTO app_order (customer_id, order_date, status, total_price, payment_method, is_paid, shipped_at, tracking_code, shipping_address_id, billing_address_id, shipping_fee) VALUES
(7, DATEADD(DAY,-12,GETDATE()), N'CANCELLED', 199000, N'COD',   0, NULL, NULL, 6, 6, 20000),
(7, DATEADD(DAY, -2,GETDATE()), N'PENDING',   449000, N'VNPAY', 0, NULL, NULL, 6, 6, 20000);
GO

-- Đơn bán tại quầy (COUNTER) – id 15, khách nhận hàng trực tiếp nên shipping_fee = 0
INSERT INTO app_order (customer_id, order_date, status, total_price, payment_method, is_paid, order_type, cashier_id, shipping_fee) VALUES
(NULL, DATEADD(DAY,-2,GETDATE()), N'COMPLETED', 294000, N'CASH', 1, N'COUNTER', 8, 0);
GO
