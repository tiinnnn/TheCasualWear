...
-- ============================================================
--  GIAO CA (từ shift_migration.sql)
-- ============================================================
...
-- ── SHIFTS (từ shift_migration.sql) ─────────────────────────
-- cashier1 = user 8
INSERT INTO shift (cashier_id, opened_at, closed_at, opening_cash, expected_cash, actual_cash, cash_difference, status, note) VALUES
(8, DATEADD(DAY,-2,GETDATE()), DATEADD(HOUR,8,DATEADD(DAY,-2,GETDATE())), 500000, 1848000, 1848000, 0, N'CLOSED', N'Ca sáng, khớp quỹ'),
(8, DATEADD(HOUR,-3,GETDATE()), NULL,                                    500000, NULL,    NULL,    NULL, N'OPEN',   NULL);
GO
